  ...
  return (
    <div
      className={
        ...
        " transition-all rounded-xl duration-200 ease-in-out flex-col bg-white/80 backdrop-blur-sm"
      }
      ref={eventLogsContainerRef}
    >
      {isExpanded && (
        <div>
          <div className="flex items-center justify-between px-6 py-3.5 sticky top-0 z-10 text-base border-b bg-white/90 backdrop-blur-sm rounded-t-xl">
